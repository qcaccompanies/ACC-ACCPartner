...
WebUI.callTestCase(findTestCase('Alda/Daftar/Kode Referal'), [('var_referral') : var_referral, ('dealer_info') : dealer_info], 
...
if (register_status == 'confirm') {
    ...
    Mobile.tap(findTestObject('Alda/Daftar/button_confirm'), 0)

    if (expected_referral == 'passed') {
        WebUI.callTestCase(findTestCase('Alda/Daftar/Halaman Daftar'), [('var_full_name') : var_full_name, ('var_username') : var_username
                ...
                , ('var_otp_5') : var_otp_5, ('var_otp_6') : var_otp_6, ('dealer_info') : dealer_info], FailureHandling.STOP_ON_FAILURE)
    } else if (expected_referral == 'failed') {
        not_run: Mobile.verifyElementVisible(findTestObject('Alda/Daftar/warn - REFERAL CODE SALAH'), 0)

        Mobile.verifyElementVisible(findTestObject('Alda/Daftar/button_confirm'), 0)
    }
} else if (register_status == 'cancel') {
    Mobile.tap(findTestObject('Alda/Daftar/button_cancel'), 0)
}
