...
Mobile.startApplication('D:\\MY WORLD\\WORKS (TUGAS)\\ACCPartner\\accpartner_290620.apk', true)
...
if (expectedReferral == 'failed') {
    ...
    Mobile.tap(findTestObject('Rizka/btnDivisi2'), 0)
    ...
    Mobile.tap(findTestObject('Rizka/Daftar - KACAB dan ADMIN HEAD/btnDealerInfo'), 0)
    ...
    if (expectedForm == 'failed') {
        ...
        if (expectedDealerInfo == 'failed') {
            if (info == 'fieldDealerInfoKosong') {
                ...
                Mobile.verifyElementVisible(findTestObject('Rizka/Daftar - KACAB dan ADMIN HEAD/alertKodePosKosong'), 0)

                Mobile.verifyElementVisible(findTestObject('Rizka/Daftar - KACAB dan ADMIN HEAD/alertKelurahanKosong'), 
                    0)

                Mobile.verifyElementVisible(findTestObject('Rizka/Daftar - KACAB dan ADMIN HEAD/alertProvinsiKosong'), 0)
            } else {
                Mobile.tap(findTestObject('Rizka/Daftar - KACAB dan ADMIN HEAD/btnDaftarDealerInfo'), 0)
