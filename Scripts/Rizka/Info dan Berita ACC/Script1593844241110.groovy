...
Mobile.tap(findTestObject('Rizka/Info dan Berita ACC/btnLihatSemua'), 0)

Mobile.delay(5, FailureHandling.STOP_ON_FAILURE)

Mobile.setText(findTestObject('Rizka/Info dan Berita ACC/fieldSearch'), namaInfo + '\\n', 0)

if (condition == 'passed') {
    Mobile.verifyElementVisible(findTestObject('Rizka/Edit Foto Profil/tapObject', [('text') : namaInfo]), 0)
} else {
    Mobile.verifyElementVisible(findTestObject('Rizka/Info dan Berita ACC/alertTidakAdaData'), 0)
}
