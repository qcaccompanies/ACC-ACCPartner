...
WebUI.callTestCase(findTestCase('Alda/Login dan Logout/Login'), [('var_username') : username, ('var_password') : katasandi
...
Mobile.tap(findTestObject('View Profile/btnTidak Keluar'), 0)
