...
Mobile.tap(findTestObject('Simulasi/tap'), 0)

Mobile.tap(findTestObject('Simulasi/tap_no_hp'), 0)

Mobile.setText(findTestObject('Simulasi/input_nomor_hp'), NoHP, 0)
...
if (UploadBy == 'Camera') {
    ...
    Mobile.tap(findTestObject('Simulasi/Konfirmasi Camera'), 0)
} else {
    Mobile.tap(findTestObject('Simulasi Kredit ATS - 18/Data_Debitur/Data Debitur - Btn Add KTP'), 0)
...
not_run: Mobile.tap(findTestObject('Simulasi Kredit ATS - 18/Data_Debitur/Ajukan_Pembiayaan_BTN'), 0)
