...
if (PaketOnOff == 'On') {
    ...
    not_run: Mobile.setText(findTestObject('Simulasi Kredit ATS - 18/Simulasi/Set_PDC'), PDC, 0)
}
...
WebUI.callTestCase(findTestCase('new simulasi kredit/Asuransi'), [('AreaPengajuan') : 'DKI Jakarta, Banten, Jawa Barat', ('Cabang') : 'FATMAWATI'
        , ('Brand') : 'TOYOTA', ('Type') : 'ALL NEW ALTIS', ('Model') : '1.8 G A/T', ('Tahun') : Tahun, ('OTR') : OTR, ('DP_PERSEN') : DP_PERSEN
        , ('DP_UANG') : DP_UANG, ('Periode') : Periode, ('Picture') : Picture, ('Pembayaran1') : Pembayaran1, ('Pembayaran2') : Pembayaran2
        , ('Pembayaran3') : Pembayaran3, ('Pembayaran4') : Pembayaran4, ('Pembayaran5') : Pembayaran5, ('CreditProtection') : CreditProtection
        , ('Plat') : Plat, ('NamaKTP') : NamaKTP, ('NoHP') : NoHP, ('AdaFoto') : AdaFoto, ('PaketOnOff') : PaketOnOff, ('PDC') : PDC
        , ('TDP') : TDP, ('Angsuran') : Angsuran, ('ProtectionType') : ProtectionType, ('Paket') : Paket, ('PembayaranAngsuran') : PembayaranAngsuran
        , ('UploadBy') : UploadBy, ('FileName') : FileName], FailureHandling.STOP_ON_FAILURE)
